...
description: >-
  ...
  Use when the user asks to build web components, pages, or applications, or wants
  polished UI, visual design, styling, layouts, or aesthetics. Generates creative,
  production-ready code that avoids generic AI aesthetics.
---
